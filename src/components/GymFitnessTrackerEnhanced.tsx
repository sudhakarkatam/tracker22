...
import { Plus, Edit2, Trash2, Dumbbell, Target, TrendingUp, Calendar, Download } from 'lucide-react';
import { Workout, Exercise, WorkoutSet, WorkoutExercise } from '@/types';
...
interface GymFitnessTrackerEnhancedProps {
  onBack: () => void;
}

export function GymFitnessTrackerEnhanced({ onBack }: GymFitnessTrackerEnhancedProps) {
  ...
  const [exercises] = useLocalStorage<Exercise[]>('exercisesDatabase', [
    { id: '1', name: 'Bench Press', category: 'strength', muscleGroups: ['chest', 'triceps'], equipment: ['barbell'], difficulty: 'intermediate', type: 'strength' },
    { id: '2', name: 'Squat', category: 'strength', muscleGroups: ['quadriceps', 'glutes'], equipment: ['barbell'], difficulty: 'intermediate', type: 'strength' },
    { id: '3', name: 'Deadlift', category: 'strength', muscleGroups: ['hamstrings', 'back'], equipment: ['barbell'], difficulty: 'advanced', type: 'strength' },
    { id: '4', name: 'Running', category: 'cardio', muscleGroups: ['legs'], equipment: ['none'], difficulty: 'beginner', type: 'cardio' },
    { id: '5', name: 'Pull-ups', category: 'strength', muscleGroups: ['back', 'biceps'], equipment: ['pull-up bar'], difficulty: 'intermediate', type: 'strength' }
  ]);
  ...
  const bulkDeleteWorkouts = () => {
    setWorkouts(prev => prev.filter(workout => !selectedWorkouts.has(workout.id)));
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-800">Enhanced Gym Tracker</h2>
      ...
      {selectedWorkouts.size > 0 && (
        <div className="bg-blue-50 p-4 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => setSelectedWorkouts(new Set())}>
                Clear Selection
              </Button>
              <Button variant="destructive" size="sm" onClick={bulkDeleteWorkouts}>
                Delete Selected
              </Button>
            </div>
          </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <Checkbox
                      ...
                      onCheckedChange={() => toggleSelectWorkout(workout.id)}
                    />
                    <div>
